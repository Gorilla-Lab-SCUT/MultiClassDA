...
class SymmNetsV1Solver(BaseSolver):
    def __init__(self, net, dataloaders, **kwargs):
        super(SymmNetsV1Solver, self).__init__(net, dataloaders, **kwargs)
    ...
    def update_network(self, **kwargs):
        ...
        while not stop:
            ...
            loss_confusion_target = 0.5 * self.SourceDiscrimLoss(output_target) + 0.5 * self.TargetDiscrimLoss(output_target)
